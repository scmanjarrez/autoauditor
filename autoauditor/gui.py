...
vpn_cb = ImageCheckBox(image_on=const.CBON, image_off=const.CBOFF,
                       image_size=const.BUTTON_S_SIZE, key=const.KEY_VPN_CB,
...
vpn_cf_i_b = button(const.NO_TEXT, const.KEY_VPN_CF_I_B,
                    ...
                    const.BUTTON_COLOR, const.NO_BORDER, const.TOOLTIP_VPN_CF,
...
vpn_cf_fb = browse(const.NO_TEXT, const.KEY_VPN_CF_FB, const.KEY_INPUT_VPN_CF,
...
bc_cf_i_b = button(const.NO_TEXT, const.KEY_BC_CF_I_B, const.INFO,
                   const.BUTTON_S_SIZE, const.BUTTON_COLOR, const.NO_BORDER,
                   const.TOOLTIP_BC_CF, disabled=True, pad=const.PAD_NO_TBR)
...
bc_lf_i_b = button(const.NO_TEXT, const.KEY_BC_LF_I_B, const.INFO,
                   const.BUTTON_S_SIZE, const.BUTTON_COLOR, const.NO_BORDER,
                   const.TOOLTIP_BC_LF, disabled=True, pad=const.PAD_NO_TBR)
...
def opt_window(msfclient, mod_list, mtype, mname, mod_idx, edit=False):
    ...
    try:
        mod = wizard.get_module(msfclient, mtype, mname)
    except TypeError:
        sg.Window('Error', [
    ...
    while True:
        ...
        if oevent == const.KEY_PAY_INFO:
            if owindow[const.KEY_PAY_DD].Get():
                ...
                pay = wizard.get_payload(msfclient, pay_n)
...
while True:
    ...
    if event is not None \
       ...
       and window_console_size is None:
        ...
        sg.Window(const.TEXT_LD, [
            [sg.Text(
                ("Absolute or relative path to directory "
                 "where gathered data should be stored."), font=const.FONT)],
    ...
    if event in (const.KEY_WIZARD_B, const.KEY_WIZARD_T):
        ...
        mod_layout = [[sg.Frame(const.NO_TEXT, [[
            ...
            button(const.NO_TEXT, const.KEY_MOD_EDIT+str(i), const.EDIT,
                   const.BUTTON_M_SIZE, const.BUTTON_COLOR, const.NO_BORDER,
                   const.TOOLTIP_MOD_EDIT, pad=const.PAD_MOD),
            button(const.NO_TEXT, const.KEY_MOD_REM+str(i), const.REMOVE,
                   const.BUTTON_M_SIZE, const.BUTTON_COLOR, const.NO_BORDER,
                   const.TOOLTIP_MOD_REMOVE),
            button(const.NO_TEXT, const.KEY_MOD_INFO+str(i), const.INFO,
                   const.BUTTON_S_SIZE, const.BUTTON_COLOR, const.NO_BORDER,
        ...
        wizard_layout = [
            ...
            [sg.Column(mod_layout, size=const.OPT_MOD_COLUMN_SIZE,
                       element_justification=const.CENTER, pad=const.PAD_NO,
                       justification=const.CENTER, scrollable=True,
                       vertical_scroll_only=True, key=const.KEY_MOD_COL)],
            [sg.Text(const.NO_TEXT, font=const.FONT, pad=const.PAD_NO)],
            [button(const.NO_TEXT, const.KEY_MOD_ADD, const.ADD,
                    const.BUTTON_L_SIZE, const.BUTTON_COLOR, const.NO_BORDER,
                    const.TOOLTIP_MOD_ADD)],
            [sg.Text(const.NO_TEXT, pad=const.PAD_NO_TB, font=const.FONTPAD)],
        ...
        while True:
            ...
            if wevent is not None and edit_regex.match(wevent):
                ...
                opt_window(
                    msfclient, mod_list, aux_mt, aux_mn, aux_mod_idx,
                    edit=True)

...
EBADRCFMT = 252  # Bad resources script (format)
...
TEXT_PAYLOAD_OPTION_INFO = 'Payload Option Info'

TEXT_REQ_SIZE = (8, 1)
TEXT_HEAD_REQ_SIZE = (5, 1)
TEXT_DESC_SIZE = (30, 1)
TEXT_DESC_SIZE_2 = (27, 1)
TEXT_DESC_SIZE_3 = (25, 1)
...
KEY_PAYLOAD = 'payload'
KEY_PAYLOAD_B = 'payload_b'
KEY_PAYLOAD_T = 'payload_t'
KEY_PAYLOAD_DD = 'payload_dd'
KEY_PAYLOAD_HELP = 'payload_help'
...
EXEC_TEXT_SIZE_L2 = (65, 1)

OPT_MOD_COLUMN_SIZE = (1128, 495)
def _get_exact_column_size(n_elem): return (1128, 33*n_elem)
